...
1. Go to the [Releases](https://github.com/dat514/Gif-Tray/releases/tag/1.0) page
2. Download the latest `Tray-Animator-Setup.exe` from [here](https://github.com/dat514/Gif-Tray/releases/download/1.0/Tray.Animator.Setup.1.0.0.exe)
3. Run the installer and follow the setup wizard
4. Launch the app from your desktop or start menu
### Build from Source
```bash
# Clone the repository
git clone https://github.com/dat514/Gif-Tray.git
cd Gif-Tray
